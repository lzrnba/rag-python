...
class Settings(BaseSettings):
    ...
    # 术语词典（PostgreSQL）配置
    TERM_DB_ENABLED: bool = False
    TERM_DB_URL: str = ""                      # 例如: jdbc:postgresql://host:5432/db
    TERM_DB_USER: str = ""
    TERM_DB_PASSWORD: str = ""
    TERM_DB_TABLE: str = "rag_term_dictionary"
    TERM_DICT_REFRESH_SECONDS: int = 60
